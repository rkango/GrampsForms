...
2. Go to the Form plugin directory (for Gramps 6.0 on Windows, it is under ```%AppData%\gramps\gramps60\plugins\forms```).
3. Place the test.xml file in the directory.
4. Reboot Gramps.
5. Go to your source and add the attribute Form with the appropriate value above.
